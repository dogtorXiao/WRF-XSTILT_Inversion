#' sampled receptors running xstilt, with default namelists
#' @author DogtorX

sample.run_xstilt = function(namelist){
    ...
    edgar_file = ffdas_file = NA                   # end if run_emiss_err
